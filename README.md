<!-- mcp-name: CSOAI-ORG/pet-care-ai-mcp -->
[![MCP Scorecard: 74/100](https://img.shields.io/badge/proofof.ai-74%2F100-5b21b6)](https://proofof.ai/scorecard/pet-care-ai-mcp.html)
...
[![PyPI](https://img.shields.io/badge/PyPI-Install-3775a9)](https://pypi.org/project/pet_care_ai_mcp/)

> Pet care MCP — vaccination tracking, feeding schedules, vet appointments, breed-specific health a...

Pet care MCP — vaccination tracking, feeding schedules, vet appointments, breed-specific health alerts. MIT.
...
```bash
# Install via pip
pip install pet_care_ai_mcp

# Or install via Smithery
npx -y @smithery/cli@latest install pet-care-ai-mcp --client claude
```
...
- [Full Documentation](https://docs.meok.ai/pet-care-ai-mcp)
